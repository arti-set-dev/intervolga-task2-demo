...
/* harmony import */ var _components_field_mask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/field-mask */ "./src/js/components/field-mask.js");
...
/* harmony import */ var _functions_remove_validation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/remove-validation */ "./src/js/functions/remove-validation.js");
/* harmony import */ var _functions_saving_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/saving-data */ "./src/js/functions/saving-data.js");
...
const contactsFormRules = [{
  ...
  rules: [{
    ...
    rule: 'customRegexp',
    value: /^(0[1-9]|[1-2][0-9]|3[0-1])\/(0[1-9]|1[0-2])\/(19[0-9][0-9]|20[0-1][0-9]|202[0-3])$/
  }]
}, {
  ruleSelector: '.fullname',
  rules: [{
    rule: 'required'
  }]
}, {
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)('.form--vehicle', contactsFormRules, afterForm);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  resetBtnElems: document.querySelectorAll('.btn-cancel'),
...
/***/ "./src/js/components/field-mask.js":
/*!*****************************************!*\
  !*** ./src/js/components/field-mask.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const inputStateNumber = new (inputmask__WEBPACK_IMPORTED_MODULE_0___default())('А 999 АА 999', {
...
const inputDate = new (inputmask__WEBPACK_IMPORTED_MODULE_0___default())('99/99/9999');
const passportSeries = new (inputmask__WEBPACK_IMPORTED_MODULE_0___default())('9999');
const passportNumber = new (inputmask__WEBPACK_IMPORTED_MODULE_0___default())('999999');
document.addEventListener('DOMContentLoaded', () => {
  var _vars$inputElems;

  (_vars$inputElems = _vars__WEBPACK_IMPORTED_MODULE_1__["default"].inputElems) === null || _vars$inputElems === void 0 ? void 0 : _vars$inputElems.forEach(input => {
    if (input !== null && input !== void 0 && input.classList.contains('statenumber')) {
      inputStateNumber.mask(input);
    }

    if (input !== null && input !== void 0 && input.classList.contains('date')) {
      inputDate.mask(input);
    }

    if (input !== null && input !== void 0 && input.classList.contains('date2')) {
      inputDate.mask(input);
    }

    if (input !== null && input !== void 0 && input.classList.contains('series')) {
      passportSeries.mask(input);
    }

    if (input !== null && input !== void 0 && input.classList.contains('number')) {
...
/***/ "./src/js/functions/remove-validation.js":
/*!***********************************************!*\
  !*** ./src/js/functions/remove-validation.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const removeValidation = () => {
  ...
  const forms = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelectorAll('.form');
  forms.forEach(formEl => {
    var _document2;

    const fields = formEl === null || formEl === void 0 ? void 0 : formEl.querySelectorAll('.input-reset');
    fields === null || fields === void 0 ? void 0 : fields.forEach(fieldEl => {
      if (fieldEl.classList.contains('just-validate-error-field')) {
        fieldEl === null || fieldEl === void 0 ? void 0 : fieldEl.classList.remove('just-validate-error-field');
        formEl === null || formEl === void 0 ? void 0 : formEl.reset();
      }

      if (fieldEl.classList.contains('just-validate-success-field')) {
        fieldEl === null || fieldEl === void 0 ? void 0 : fieldEl.classList.remove('just-validate-success-field');
      }

      formEl === null || formEl === void 0 ? void 0 : formEl.reset();
      localStorage.removeItem('formData');
    });
    const errorLabels = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelectorAll('.just-validate-error-label');
    errorLabels === null || errorLabels === void 0 ? void 0 : errorLabels.forEach(errorLabel => {
      errorLabel === null || errorLabel === void 0 ? void 0 : errorLabel.remove();
    });
  });
};
document.addEventListener('DOMContentLoaded', () => {
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].resetBtnElems.forEach(closeBtnEl => {
    closeBtnEl === null || closeBtnEl === void 0 ? void 0 : closeBtnEl.addEventListener('click', () => {
      removeValidation();
    });
  });
});
...
/***/ "./src/js/functions/saving-data.js":
/*!*****************************************!*\
  !*** ./src/js/functions/saving-data.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "savingData": () => (/* binding */ savingData)
/* harmony export */ });
/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_vars */ "./src/js/_vars.js");
var _vars$formElems;
...
(_vars$formElems = _vars__WEBPACK_IMPORTED_MODULE_0__["default"].formElems) === null || _vars$formElems === void 0 ? void 0 : _vars$formElems.forEach(form => {
...
const validateForms = (selector, rules, afterSend) => {
  ...
  const inputStateNumber = form === null || form === void 0 ? void 0 : form.querySelector('.statenumber');
  const passportSeries = form === null || form === void 0 ? void 0 : form.querySelector('.series');
  const passportNumber = form === null || form === void 0 ? void 0 : form.querySelector('.number');
